...
WPromise<int> Task1() {
  return [] -> Promise<int> { co_return 10; };
}

WPromise<double> Task2() {
  return [] -> Promise<double> { co_return 3.14; };
}

WPromise<std::string> Task3() {
  return [] -> Promise<std::string> { co_return "complete"; };
}

WPromise<void> PromiseAllExample() {
  return [] -> Promise<void> {
...
WPromise<void> PromiseAllWithVoid() {
  return [] -> Promise<void> {
    std::cout << "=== promise::All with Void ===\n";

    auto all =
        promise::All(Task1(), [] -> Promise<void> { co_return; }, Task2());
...
WPromise<void> PromiseRaceExample() {
  return [] -> Promise<void> {
...
WPromise<void> PromiseRaceVariant() {
  return [] -> Promise<void> {
...
WPromise<void> PromiseRaceWithError() {
  return [] -> Promise<void> {
