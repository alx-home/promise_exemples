...
WPromise<void> ThreadPoolExample() {
  return [] -> Promise<void> {
...
// Not Yet ;)
// WPromise<void> PoolWithMultipleTasks() {
//   return [] -> Promise<void> {
...
WPromise<void> MessageQueueExample() {
  return [] -> Promise<void> {
...
WPromise<void> PoolWithDelayedDispatch() {
  return [] -> Promise<void> {
